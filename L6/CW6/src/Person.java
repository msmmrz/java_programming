...
public class Person {
    ...
    public void insert(String name,String username,String pass,String email){
        try (Connection connection = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "masoume", "myjava123")) {
            ...
            PreparedStatement preparedStatement1 = connection.prepareStatement("select * from user where  username =? and pass =? ");
            ...
            if (resultSet2.next()) {
                ...
                //create table user(name varchar2(20),pass varchar2(20),username varchar2(20),email varchar2(35));
                PreparedStatement preparedStatement = connection.prepareStatement("insert into user (name,username,pass,email) values (?,?,?,?)");
    ...
    public void select(String username,String pass) {
        try (Connection connection = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "masoume", "myjava123")) {
            Class.forName("oracle.jdbc.OracleDriver");
            PreparedStatement preparedStatement2 = connection.prepareStatement("select * from user where username = ? and pass=? ");
        ...
        } catch (ClassNotFoundException e)
        {
            ...
            System.out.println("operation is field!!!");
        }
